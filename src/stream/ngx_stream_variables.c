...
static ngx_int_t ngx_stream_variable_apache3_version(ngx_stream_session_t *s,
    ngx_stream_variable_value_t *v, uintptr_t data);
...
static ngx_stream_variable_t  ngx_stream_core_variables[] = {
    ...
    { ngx_string("apache3_version"), NULL, ngx_stream_variable_apache3_version,
      0, 0, 0 },
...
static ngx_int_t
ngx_stream_variable_apache3_version(ngx_stream_session_t *s,
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    v->len = sizeof(APACHE3_VERSION) - 1;
    v->valid = 1;
    v->no_cacheable = 0;
    v->not_found = 0;
    v->data = (u_char *) APACHE3_VERSION;
