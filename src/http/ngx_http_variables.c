...
static ngx_int_t ngx_http_variable_apache3_version(ngx_http_request_t *r,
    ngx_http_variable_value_t *v, uintptr_t data);
...
static ngx_http_variable_t  ngx_http_core_variables[] = {
    ...
    { ngx_string("apache3_version"), NULL, ngx_http_variable_apache3_version,
      0, 0, 0 },
...
static ngx_int_t
ngx_http_variable_apache3_version(ngx_http_request_t *r,
    ngx_http_variable_value_t *v, uintptr_t data)
{
